...
def launch_setup(context, *args, **kwargs):
    ...
    nodes = [
        ...
        Node(name='robot_state_publisher',
             ...
             output='screen',
             parameters=[{'robot_description': PANDA_DESCRIPTION}]),
        Node(name='lively_ik',
             package='lively_ik',
